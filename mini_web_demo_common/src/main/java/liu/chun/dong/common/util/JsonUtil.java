...
public final class JsonUtil {
    ...
    public static void main(String[] args) {
        ...
        str1[0] = "1";
        str1[1] = "2";
        System.out.println(JsonUtil.array2Json(str1));

        System.out.println(JsonUtil.boolean2Json(true));

        boolean[] booleans = new boolean[2];
        booleans[0] = true;
        booleans[1] = false;
        System.out.println(JsonUtil.booleanArray2Json(booleans));

        byte[] bytes = new byte[2];
        bytes[0] = 1;
        bytes[1] = 2;
        System.out.println(JsonUtil.byteArray2Json(bytes));

        TestDto testDto = new TestDto("liuchundong", 30);
        System.out.println(JsonUtil.object2Json(testDto));
        ...
        list.add("1");
        list.add(2);
        System.out.println(JsonUtil.collection2Json(list));
