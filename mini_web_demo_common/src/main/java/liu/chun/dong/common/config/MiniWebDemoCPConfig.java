package liu.chun.dong.common.config;

import liu.chun.dong.common.bean.MiniWebDemoCPConfigBean;
 ...
 * @version 1.0.0
 * @date 2015/3/8 18:27
 * @comment MiniWebDemoCPConfig
 */
public class MiniWebDemoCPConfig implements MiniWebDemoCPConfigBean {
    /**
     * 连接URL
     */
    ...
    /**
     * lazy init pool
     * true: init min connections in Monitor thread, else do it in new MiniWebDemoCP/getConnection() thread
     */
