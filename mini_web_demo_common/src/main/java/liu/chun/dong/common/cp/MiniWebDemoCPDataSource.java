 ...
 * @version 1.0.0
 * @date 2015/3/8 18:32
 * @comment MiniWebDemoCPDataSource
 */
public class MiniWebDemoCPDataSource extends MiniWebDemoCPConfig implements DataSource, ObjectFactory{
    private ReadWriteLock rwl = new ReentrantReadWriteLock();

    private MiniWebDemoCP pool = null;
...
//    }
    ...
    public Object getObjectInstance(Object object, Name name, Context nameCtx, Hashtable<?, ?> environment) throws Exception {
        ...
        MiniWebDemoCPDataSource ds = new MiniWebDemoCPDataSource();
            ...
            if (this.pool == null) { // this.pool is protected in getConnection
                ...
                try {
                    if (this.pool == null) { // read might have passed, write
                        // might not
                        this.pool = new MiniWebDemoCP(this);
                    }
                } finally {
                    this.rwl.readLock().lock();
