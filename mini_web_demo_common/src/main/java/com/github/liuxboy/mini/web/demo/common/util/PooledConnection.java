...
import com.github.liuxboy.mini.web.demo.common.bean.IDataBaseConnectionConfig;
 ...
 */
public class PooledConnection implements InvocationHandler, IDataBaseConnectionConfig {
     ...
     * 归属连接池
     */
    private final DataBasePoolConfigImpl connectionPool;
    /**
     * 连接Id
     */
    ...
    PooledConnection(DataBasePoolConfigImpl pool, int connId) throws SQLException {
        connectionPool = pool;
        connectionId = connId;
    ...
    private void makeRealConnection() throws SQLException {
        ...
        // conneciton properties 放到 DataBaseDataSource 中统一维护
...
//            }
     ...
     * @return connectionPool
     */
    public DataBasePoolConfigImpl getConnectionPool() {
        return connectionPool;
    }
